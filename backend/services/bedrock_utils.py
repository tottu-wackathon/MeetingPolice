...
def classify_transcript_segments(
    ...
    prompt = (
        ...
        "\n"
        "【重要】一致度（alignment）は「アジェンダと内容がどれだけ近しいか」を 60〜100% で採点してください。\n"
        "- 90-100%: アジェンダの中心的な話題に直接言及している\n"
        "- 75-89% : アジェンダに明確に関連し、具体的な論点に触れている\n"
        "- 60-74% : アジェンダと緩やかに関連する話題（周辺情報や導入など）\n"
        "  60%未満は使わず、最低でも60%を付与してください。\n"
        "\n"
        "カテゴリ定義:\n"
        f"{category_guidance}\n"
        "\n"
...
def _guess_category(text: str) -> str:
    ...
    cues = [
        ...
        ("感想・意見", ["思う", "思います", "思うんです", "思うんですが", "思うんですけど", "かなと", "感じ", "印象"]),
